CLASS zcl_carga_bib_0932 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_carga_bib_0932 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    DATA: lt_acc_categ TYPE TABLE OF ztb_acccate_0932,
          lt_catego    TYPE TABLE OF ztb_catego_0932,
          lt_clientes  TYPE TABLE OF ztb_cltes_0932,
          lt_clnts_lib TYPE TABLE OF ztb_clt_lib_0932,
          lt_libros    TYPE TABLE OF ztb_libros_0932.
...
******** TABLA1 ********
    ...
    DELETE FROM ztb_acccate_0932.
    INSERT ztb_acccate_0932 FROM TABLE @lt_acc_categ.
...
******** ztb_catego_0932 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_0932.
    INSERT ztb_catego_0932 FROM TABLE @lt_catego.
...
******** ztb_cltes_0932 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cltes_0932.
    INSERT ztb_cltes_0932 FROM TABLE @lt_clientes.
...
******** ztb_libros_0932 ********
    ...
    INSERT ztb_libros_0932 FROM TABLE @lt_libros.
